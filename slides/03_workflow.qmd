...
Example szenario: in your daily work, you notice that you need certain one-off
...
![[Photo CC0 by ELEVATE on pexels.com]{.copyright}](thumbnails/workflow1.jpg){fig-align="center"}
...
<!-- https://blog.devart.com/software-development-life-cycle.html -->

![](resources/agile_model.jpg "Agile Model")

# Workflow in Practice

![[Photo CC0 by Chevanon Photography on pexels.com]{.copyright}](thumbnails/workflow2.jpg){fig-align="center"}
...
[^1]: Regulators want to know: is the package reliable?

## Why practice good engineering?

Invest time in requirements analysis, software design, and architecture...

. . .

... but in most cases the workflow must be workable for a single developer or a
small team.
...
The R package *simlatr* shall enable the creation of reproducible fake data.

**Package Requirements**

*simlatr* **shall** provide a function to generate normal distributed random
...
URS: Rmd, Quarto, README, LaTeX, Word, Polarion, ...

Software design specification - A picture is worth a thousand words:
<http://draw.io>
...
2.  C&P existing R scripts (one-off scripts, prototype functions) and refactor
    it if necessary
...
Define that the result is a list[^3] which is defined as class[^4]:

[^3]: It's common practice to add the function arguments to the result
    $\rightarrow$ should be a list or class

[^4]: To implement generics, the result must be a class
...
#' 
#' @examples
#' x <- getSimluatedTwoArmMeans(n1 = 50, n2 = 50, mean1 = 5, 
...
![[Photo CC0 by Pixabay on pexels.com]{.copyright}](thumbnails/exercise.jpg){fig-align="center"}
