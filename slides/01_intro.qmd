...
*Any opinions expressed in this presentation and on the following slides are
solely those of the presenter and not necessarily those of their respective
employer or company.*
...
* feel free to connect at `r fontawesome::fa("linkedin")` [LinkedIn](https://www.linkedin.com/in/kevin-kunzmann-6486a11bb/) or 
`r fontawesome::fa("github")` [Github](https://github.com/kkmann) 
:::
...
|               |                       |
|--------------:|:----------------------|
| 09:00 - 09:45 | **Introduction, Outline** |
| 09:45 - 10:45 | **R packages, what are they? + exercise** |
| 10:45 - 12:00 | **Workflow for creating R packages + exercise** |
| 12:00 - 13:00 | Lunch break, chat & network |
| 13:00 - 14:00 | **Package quality + exercise** |
| 14:00 - 15:30 | **Collaboration with git & GitHub + group exercise** |
| 15:30 - 16:00 | Coffee break, chat & network |
| 16:00 - 17:00 | **Publication + exercise** |
...
- Course website at [https://kkmann.github.io/workshop-r-swe/](https://kkmann.github.io/workshop-r-swe/)
  * all slides
  * sources available at [https://github.com/kkmann/workshop-r-swe](https://github.com/kkmann/workshop-r-swe)
