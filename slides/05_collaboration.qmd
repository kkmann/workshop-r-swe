...
-   Merging parallel edits is not simple (try it in MS Word 365)
...
-   Essentially a database of with snapshots of a monitored 'repository' (directory)
-   Optimized to compute 'diffs' (line-based changes)
...
-   We will go through the steps for setting up the next exercise
-   Will try to perform a live PR :)
-   Don't panic - steps are all documented!
